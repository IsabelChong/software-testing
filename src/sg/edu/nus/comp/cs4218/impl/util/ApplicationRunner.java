...
public class ApplicationRunner {
    ...
    /**
     * Run the application as specified by the application command keyword and
     * arguments.
     *
     * @param app          String containing the keyword that specifies what
     *                     application to run.
     * @param argsArray    String array containing the arguments to pass to the
     *                     applications for
     *                     running.
     * @param inputStream  InputStream for the application to get input from, if
     *                     needed.
     * @param outputStream OutputStream for the application to write its output to.
     * @throws AbstractApplicationException If an exception happens while running an
     *                                      application.
     * @throws ShellException               If an unsupported or invalid application
     *                                      command is
     *                                      detected.
     */
